...
public class DossierLogLocalServiceUtil {
	...
	*/
	public static org.opencps.dossiermgt.model.DossierLog addDossierLog(
		...
		return getService()
			...
			actor, actionInfo, messageInfo, updateDatetime, level,
			serviceContext);
	}
	...
	public static org.opencps.dossiermgt.model.DossierLog addDossierLog(
		...
		return getService()
				   .addDossierLog(userId, dossierId, fileGroupId, status,
			actor, actorId, actorName, actionInfo, messageInfo, updateDatetime,
	...
	*/
	public static org.opencps.dossiermgt.model.DossierLog addDossierLog(
		long userId, long groupId, long companyId, long dossierId,
		long fileGroupId, java.lang.String dossierStatus, int actor,
		long actorId, java.lang.String actorName,
	...
	*/
	public static java.util.List<org.opencps.dossiermgt.model.DossierLog> getDossierLogByDossierId(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getDossierLogByDossierId(dossierId, syncStatus);
	}

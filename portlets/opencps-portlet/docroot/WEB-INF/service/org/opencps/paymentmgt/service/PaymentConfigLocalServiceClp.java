...
public class PaymentConfigLocalServiceClp implements PaymentConfigLocalService {
	public PaymentConfigLocalServiceClp(
		...
		_methodName21 = "getPaymentConfigByGovAgency";
	...
	public org.opencps.paymentmgt.model.PaymentConfig addPaymentConfig(
		...
		return (org.opencps.paymentmgt.model.PaymentConfig)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<org.opencps.paymentmgt.model.PaymentConfig> getPaymentConfigs(
		...
		return (java.util.List<org.opencps.paymentmgt.model.PaymentConfig>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public org.opencps.paymentmgt.model.PaymentConfig addPaymentConfig(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(govAgencyTaxNo),
						
					ClpSerializer.translateInput(invoiceTemplateNo),
						
					ClpSerializer.translateInput(invoiceIssueNo),
						
					ClpSerializer.translateInput(invoiceLastNo),
						
					ClpSerializer.translateInput(bankInfo),
						
					ClpSerializer.translateInput(placeInfo),
						
					ClpSerializer.translateInput(keypayDomain),
						
					ClpSerializer.translateInput(keypayVersion),
						
					ClpSerializer.translateInput(keypayMerchantCode),
						
					ClpSerializer.translateInput(keypaySecureKey),
						
					ClpSerializer.translateInput(reportTemplate),
	...
	public org.opencps.paymentmgt.model.PaymentConfig getPaymentConfigByGovAgency(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					new Object[] { groupId, govAgencyOrganizationId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);

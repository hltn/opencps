...
/**
 * Provides the local service interface for ApiService. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see ApiServiceLocalServiceUtil
...
public interface ApiServiceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApiServiceLocalServiceUtil} to access the api service local service. Add custom service methods to {@link org.opencps.api.service.impl.ApiServiceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

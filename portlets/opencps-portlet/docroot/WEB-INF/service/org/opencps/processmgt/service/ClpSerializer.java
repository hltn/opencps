...
import org.opencps.processmgt.model.SchedulerJobsClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(SchedulerJobsClp.class.getName())) {
			return translateInputSchedulerJobs(oldModel);
		}
	...
	public static Object translateInputSchedulerJobs(BaseModel<?> oldModel) {
		SchedulerJobsClp oldClpModel = (SchedulerJobsClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getSchedulerJobsRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"org.opencps.processmgt.model.impl.SchedulerJobsImpl")) {
			return translateOutputSchedulerJobs(oldModel);
		}
		else if (oldModelClassName.endsWith("Clp")) {
			try {
				ClassLoader classLoader = ClpSerializer.class.getClassLoader();
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
			...
			return new org.opencps.processmgt.NoSuchSchedulerJobsException();
		}
	...
	public static Object translateOutputSchedulerJobs(BaseModel<?> oldModel) {
		SchedulerJobsClp newModel = new SchedulerJobsClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setSchedulerJobsRemoteModel(oldModel);

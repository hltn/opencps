...
public class ProcessOrderLocalServiceUtil {
	...
	* @throws SystemException
	*/
	public static java.util.List<org.opencps.processmgt.model.ProcessOrder> getProcessOrdersByServiceInfoId(
		long serviceinfoId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getProcessOrdersByServiceInfoId(serviceinfoId);
	}

...
public class ServiceInfoPersistenceImpl extends BasePersistenceImpl<ServiceInfo>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_DI = new FinderPath(ServiceInfoModelImpl.ENTITY_CACHE_ENABLED,
			ServiceInfoModelImpl.FINDER_CACHE_ENABLED, ServiceInfoImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_DI",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_DI = new FinderPath(ServiceInfoModelImpl.ENTITY_CACHE_ENABLED,
			ServiceInfoModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByG_DI",
	 ...
	 */
	@Override
	public List<ServiceInfo> findByG_DI(long groupId, String domainIndex)
		throws SystemException {
		return findByG_DI(groupId, domainIndex, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ServiceInfo> findByG_DI(long groupId, String domainIndex,
		int start, int end) throws SystemException {
		return findByG_DI(groupId, domainIndex, start, end, null);
	}
	...
	public List<ServiceInfo> findByG_DI(long groupId, String domainIndex,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_DI;
		finderArgs = new Object[] {
				groupId, domainIndex,
			...
			for (ServiceInfo serviceInfo : list) {
				if ((groupId != serviceInfo.getGroupId()) ||
						!StringUtil.wildcardMatches(
							serviceInfo.getDomainIndex(), domainIndex,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_DI_GROUPID_2);

			boolean bindDomainIndex = false;

			if (domainIndex == null) {
				query.append(_FINDER_COLUMN_G_DI_DOMAININDEX_1);
			}
			else if (domainIndex.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_G_DI_DOMAININDEX_3);
			}
			else {
				bindDomainIndex = true;

				query.append(_FINDER_COLUMN_G_DI_DOMAININDEX_2);
			}
	 ...
	 */
	@Override
	public ServiceInfo findByG_DI_First(long groupId, String domainIndex,
		OrderByComparator orderByComparator)
		throws NoSuchServiceInfoException, SystemException {
		ServiceInfo serviceInfo = fetchByG_DI_First(groupId, domainIndex,
				orderByComparator);
	 ...
	 */
	@Override
	public ServiceInfo fetchByG_DI_First(long groupId, String domainIndex,
		OrderByComparator orderByComparator) throws SystemException {
		List<ServiceInfo> list = findByG_DI(groupId, domainIndex, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public ServiceInfo findByG_DI_Last(long groupId, String domainIndex,
		OrderByComparator orderByComparator)
		throws NoSuchServiceInfoException, SystemException {
		ServiceInfo serviceInfo = fetchByG_DI_Last(groupId, domainIndex,
				orderByComparator);
	 ...
	 */
	@Override
	public ServiceInfo fetchByG_DI_Last(long groupId, String domainIndex,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByG_DI(groupId, domainIndex);

		if (count == 0) {
			return null;
		}

		List<ServiceInfo> list = findByG_DI(groupId, domainIndex, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public ServiceInfo[] findByG_DI_PrevAndNext(long serviceinfoId,
		long groupId, String domainIndex, OrderByComparator orderByComparator)
		throws NoSuchServiceInfoException, SystemException {
		ServiceInfo serviceInfo = findByPrimaryKey(serviceinfoId);
		...
		try {
			...
			array[0] = getByG_DI_PrevAndNext(session, serviceInfo, groupId,
					domainIndex, orderByComparator, true);

			array[1] = serviceInfo;

			array[2] = getByG_DI_PrevAndNext(session, serviceInfo, groupId,
					domainIndex, orderByComparator, false);
	...
	protected ServiceInfo getByG_DI_PrevAndNext(Session session,
		ServiceInfo serviceInfo, long groupId, String domainIndex,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<ServiceInfo> filterFindByG_DI(long groupId, String domainIndex)
		throws SystemException {
		return filterFindByG_DI(groupId, domainIndex, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<ServiceInfo> filterFindByG_DI(long groupId, String domainIndex,
		int start, int end) throws SystemException {
		return filterFindByG_DI(groupId, domainIndex, start, end, null);
	}
	...
	public List<ServiceInfo> filterFindByG_DI(long groupId, String domainIndex,
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_DI(groupId, domainIndex, start, end,
				orderByComparator);
		}
	 ...
	 */
	@Override
	public ServiceInfo[] filterFindByG_DI_PrevAndNext(long serviceinfoId,
		long groupId, String domainIndex, OrderByComparator orderByComparator)
		throws NoSuchServiceInfoException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_DI_PrevAndNext(serviceinfoId, groupId, domainIndex,
				orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_DI_PrevAndNext(session, serviceInfo,
					groupId, domainIndex, orderByComparator, true);

			array[1] = serviceInfo;

			array[2] = filterGetByG_DI_PrevAndNext(session, serviceInfo,
					groupId, domainIndex, orderByComparator, false);
	...
	protected ServiceInfo filterGetByG_DI_PrevAndNext(Session session,
		ServiceInfo serviceInfo, long groupId, String domainIndex,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByG_DI(long groupId, String domainIndex)
		throws SystemException {
		for (ServiceInfo serviceInfo : findByG_DI(groupId, domainIndex,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(serviceInfo);
		}
	}
	 ...
	 */
	@Override
	public int countByG_DI(long groupId, String domainIndex)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_G_DI;

		Object[] finderArgs = new Object[] { groupId, domainIndex };
	 ...
	 */
	@Override
	public int filterCountByG_DI(long groupId, String domainIndex)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_DI(groupId, domainIndex);
		}
	...
	private static final String _FINDER_COLUMN_G_DI_GROUPID_2 = "serviceInfo.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_DI_DOMAININDEX_1 = "serviceInfo.domainIndex LIKE NULL";
	private static final String _FINDER_COLUMN_G_DI_DOMAININDEX_2 = "serviceInfo.domainIndex LIKE ?";
	private static final String _FINDER_COLUMN_G_DI_DOMAININDEX_3 = "(serviceInfo.domainIndex IS NULL OR serviceInfo.domainIndex LIKE '')";
	...
	protected ServiceInfo toUnwrappedModel(ServiceInfo serviceInfo) {
		...
		serviceInfoImpl.setFullName(serviceInfo.getFullName());

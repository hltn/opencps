...
public class JobPosPersistenceImpl extends BasePersistenceImpl<JobPos>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_TITLE = new FinderPath(JobPosModelImpl.ENTITY_CACHE_ENABLED,
			JobPosModelImpl.FINDER_CACHE_ENABLED, JobPosImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByTitle",
			new String[] { Long.class.getName(), String.class.getName() },
			JobPosModelImpl.GROUPID_COLUMN_BITMASK |
			JobPosModelImpl.TITLE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_TITLE = new FinderPath(JobPosModelImpl.ENTITY_CACHE_ENABLED,
			JobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public JobPos findByTitle(long groupId, String title)
		throws NoSuchJobPosException, SystemException {
		JobPos jobPos = fetchByTitle(groupId, title);
	 ...
	 */
	@Override
	public JobPos fetchByTitle(long groupId, String title)
		throws SystemException {
		return fetchByTitle(groupId, title, true);
	}
	...
	public JobPos fetchByTitle(long groupId, String title,
		...
		if (result instanceof JobPos) {
			...
			if ((groupId != jobPos.getGroupId()) ||
					!Validator.equals(title, jobPos.getTitle())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_TITLE_GROUPID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((list.size() > 1) && _log.isWarnEnabled()) {
						_log.warn(
							"JobPosPersistenceImpl.fetchByTitle(long, String, boolean) with parameters (" +
					...
					if ((jobPos.getGroupId() != groupId) ||
							(jobPos.getTitle() == null) ||
							!jobPos.getTitle().equals(title)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_TITLE,
							finderArgs, jobPos);
					}
				}
	 ...
	 */
	@Override
	public JobPos removeByTitle(long groupId, String title)
		throws NoSuchJobPosException, SystemException {
		JobPos jobPos = findByTitle(groupId, title);
	 ...
	 */
	@Override
	public int countByTitle(long groupId, String title)
		throws SystemException {
	...
	private static final String _FINDER_COLUMN_TITLE_GROUPID_2 = "jobPos.groupId = ? AND ";
	private static final String _FINDER_COLUMN_TITLE_TITLE_1 = "jobPos.title IS NULL";
	private static final String _FINDER_COLUMN_TITLE_TITLE_2 = "jobPos.title = ?";
	private static final String _FINDER_COLUMN_TITLE_TITLE_3 = "(jobPos.title IS NULL OR jobPos.title = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_T_W = new FinderPath(JobPosModelImpl.ENTITY_CACHE_ENABLED,
			JobPosModelImpl.FINDER_CACHE_ENABLED, JobPosImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByG_T_W",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_T_W = new FinderPath(JobPosModelImpl.ENTITY_CACHE_ENABLED,
			JobPosModelImpl.FINDER_CACHE_ENABLED, JobPosImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByG_T_W",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			},
			...
			JobPosModelImpl.TITLE_COLUMN_BITMASK |
			JobPosModelImpl.WORKINGUNITID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_G_T_W = new FinderPath(JobPosModelImpl.ENTITY_CACHE_ENABLED,
			JobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByG_T_W",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			});
	 ...
	 */
	@Override
	public List<JobPos> findByG_T_W(long groupId, String title,
		long workingUnitId) throws SystemException {
		return findByG_T_W(groupId, title, workingUnitId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<JobPos> findByG_T_W(long groupId, String title,
		...
		return findByG_T_W(groupId, title, workingUnitId, start, end, null);
	}
	...
	public List<JobPos> findByG_T_W(long groupId, String title,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_T_W;
			finderArgs = new Object[] { groupId, title, workingUnitId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_G_T_W;
			finderArgs = new Object[] {
					groupId, title, workingUnitId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_G_T_W_GROUPID_2);

			boolean bindTitle = false;

			if (title == null) {
				query.append(_FINDER_COLUMN_G_T_W_TITLE_1);
			}
			else if (title.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_G_T_W_TITLE_3);
			}
			else {
				bindTitle = true;

				query.append(_FINDER_COLUMN_G_T_W_TITLE_2);
			}

			query.append(_FINDER_COLUMN_G_T_W_WORKINGUNITID_2);
	 ...
	 */
	@Override
	public JobPos findByG_T_W_First(long groupId, String title,
		long workingUnitId, OrderByComparator orderByComparator)
		throws NoSuchJobPosException, SystemException {
		JobPos jobPos = fetchByG_T_W_First(groupId, title, workingUnitId,
				orderByComparator);
	 ...
	 */
	@Override
	public JobPos fetchByG_T_W_First(long groupId, String title,
		long workingUnitId, OrderByComparator orderByComparator)
		throws SystemException {
		List<JobPos> list = findByG_T_W(groupId, title, workingUnitId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public JobPos findByG_T_W_Last(long groupId, String title,
		long workingUnitId, OrderByComparator orderByComparator)
		throws NoSuchJobPosException, SystemException {
		JobPos jobPos = fetchByG_T_W_Last(groupId, title, workingUnitId,
				orderByComparator);
	 ...
	 */
	@Override
	public JobPos fetchByG_T_W_Last(long groupId, String title,
		long workingUnitId, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByG_T_W(groupId, title, workingUnitId);

		if (count == 0) {
			return null;
		}

		List<JobPos> list = findByG_T_W(groupId, title, workingUnitId,
	 ...
	 */
	@Override
	public JobPos[] findByG_T_W_PrevAndNext(long jobPosId, long groupId,
		String title, long workingUnitId, OrderByComparator orderByComparator)
		throws NoSuchJobPosException, SystemException {
		JobPos jobPos = findByPrimaryKey(jobPosId);
		...
		try {
			...
			array[0] = getByG_T_W_PrevAndNext(session, jobPos, groupId, title,
					workingUnitId, orderByComparator, true);

			array[1] = jobPos;

			array[2] = getByG_T_W_PrevAndNext(session, jobPos, groupId, title,
					workingUnitId, orderByComparator, false);
	...
	protected JobPos getByG_T_W_PrevAndNext(Session session, JobPos jobPos,
		long groupId, String title, long workingUnitId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<JobPos> filterFindByG_T_W(long groupId, String title,
		long workingUnitId) throws SystemException {
		return filterFindByG_T_W(groupId, title, workingUnitId,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<JobPos> filterFindByG_T_W(long groupId, String title,
		long workingUnitId, int start, int end) throws SystemException {
		return filterFindByG_T_W(groupId, title, workingUnitId, start, end, null);
	}
	...
	public List<JobPos> filterFindByG_T_W(long groupId, String title,
		...
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_T_W(groupId, title, workingUnitId, start, end,
				orderByComparator);
		}
	 ...
	 */
	@Override
	public JobPos[] filterFindByG_T_W_PrevAndNext(long jobPosId, long groupId,
		String title, long workingUnitId, OrderByComparator orderByComparator)
		throws NoSuchJobPosException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_T_W_PrevAndNext(jobPosId, groupId, title,
		...
		try {
			...
			array[0] = filterGetByG_T_W_PrevAndNext(session, jobPos, groupId,
					title, workingUnitId, orderByComparator, true);

			array[1] = jobPos;

			array[2] = filterGetByG_T_W_PrevAndNext(session, jobPos, groupId,
					title, workingUnitId, orderByComparator, false);
	...
	protected JobPos filterGetByG_T_W_PrevAndNext(Session session,
		JobPos jobPos, long groupId, String title, long workingUnitId,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByG_T_W(long groupId, String title, long workingUnitId)
		throws SystemException {
		for (JobPos jobPos : findByG_T_W(groupId, title, workingUnitId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(jobPos);
		}
	}
	 ...
	 */
	@Override
	public int countByG_T_W(long groupId, String title, long workingUnitId)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_G_T_W;

		Object[] finderArgs = new Object[] { groupId, title, workingUnitId };
	 ...
	 */
	@Override
	public int filterCountByG_T_W(long groupId, String title, long workingUnitId)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_T_W(groupId, title, workingUnitId);
		}
	...
	private static final String _FINDER_COLUMN_G_T_W_GROUPID_2 = "jobPos.groupId = ? AND ";
	private static final String _FINDER_COLUMN_G_T_W_TITLE_1 = "jobPos.title IS NULL AND ";
	private static final String _FINDER_COLUMN_G_T_W_TITLE_2 = "jobPos.title = ? AND ";
	private static final String _FINDER_COLUMN_G_T_W_TITLE_3 = "(jobPos.title IS NULL OR jobPos.title = '') AND ";
	private static final String _FINDER_COLUMN_G_T_W_WORKINGUNITID_2 = "jobPos.workingUnitId = ?";
	...
	public void clearCache(JobPos jobPos) {
		...
		clearUniqueFindersCache(jobPos);
	}
	...
	protected void cacheUniqueFindersCache(JobPos jobPos) {
		if (jobPos.isNew()) {
			Object[] args = new Object[] { jobPos.getGroupId(), jobPos.getTitle() };

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_TITLE, args,
				Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_TITLE, args, jobPos);
		}
		else {
			...
			if ((jobPosModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						jobPos.getGroupId(), jobPos.getTitle()
					};
	...
	protected void clearUniqueFindersCache(JobPos jobPos) {
		JobPosModelImpl jobPosModelImpl = (JobPosModelImpl)jobPos;
	...
	public JobPos updateImpl(org.opencps.usermgt.model.JobPos jobPos)
		...
		if (isNew || !JobPosModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((jobPosModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_T_W.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						jobPosModelImpl.getOriginalGroupId(),
						jobPosModelImpl.getOriginalTitle(),
						jobPosModelImpl.getOriginalWorkingUnitId()
				...
				FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_G_T_W, args);
				FinderCacheUtil.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_T_W,
					args);
		...
		clearUniqueFindersCache(jobPos);
		cacheUniqueFindersCache(jobPos);

...
public class WorkingUnitPersistenceImpl extends BasePersistenceImpl<WorkingUnit>
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID = new FinderPath(WorkingUnitModelImpl.ENTITY_CACHE_ENABLED,
			WorkingUnitModelImpl.FINDER_CACHE_ENABLED, WorkingUnitImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByMappingOrganisationId",
			new String[] { Long.class.getName(), Long.class.getName() },
			WorkingUnitModelImpl.GROUPID_COLUMN_BITMASK |
			WorkingUnitModelImpl.MAPPINGORGANISATIONID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_MAPPINGORGANISATIONID = new FinderPath(WorkingUnitModelImpl.ENTITY_CACHE_ENABLED,
			WorkingUnitModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByMappingOrganisationId",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public WorkingUnit findByMappingOrganisationId(long groupId,
		long mappingOrganisationId)
		throws NoSuchWorkingUnitException, SystemException {
		WorkingUnit workingUnit = fetchByMappingOrganisationId(groupId,
		...
		if (workingUnit == null) {
			...
			msg.append(", mappingOrganisationId=");
			msg.append(mappingOrganisationId);
	 ...
	 */
	@Override
	public WorkingUnit fetchByMappingOrganisationId(long groupId,
		long mappingOrganisationId) throws SystemException {
		return fetchByMappingOrganisationId(groupId, mappingOrganisationId, true);
	}
	...
	@Override
	public WorkingUnit fetchByMappingOrganisationId(long groupId,
		long mappingOrganisationId, boolean retrieveFromCache)
		throws SystemException {
		Object[] finderArgs = new Object[] { groupId, mappingOrganisationId };

		Object result = null;

		if (retrieveFromCache) {
			result = FinderCacheUtil.getResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_MAPPINGORGANISATIONID_GROUPID_2);

			query.append(_FINDER_COLUMN_MAPPINGORGANISATIONID_MAPPINGORGANISATIONID_2);
			...
			try {
				...
				qPos.add(mappingOrganisationId);

				List<WorkingUnit> list = q.list();

				if (list.isEmpty()) {
					FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
						finderArgs, list);
				}
				else {
					WorkingUnit workingUnit = list.get(0);
					...
					if ((workingUnit.getGroupId() != groupId) ||
							(workingUnit.getMappingOrganisationId() != mappingOrganisationId)) {
						FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
							finderArgs, workingUnit);
					}
				}
				...
				FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
					finderArgs);
	 ...
	 */
	@Override
	public WorkingUnit removeByMappingOrganisationId(long groupId,
		long mappingOrganisationId)
		throws NoSuchWorkingUnitException, SystemException {
		WorkingUnit workingUnit = findByMappingOrganisationId(groupId,
				mappingOrganisationId);
	...
	public int countByMappingOrganisationId(long groupId,
		long mappingOrganisationId) throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_MAPPINGORGANISATIONID;
	...
	private static final String _FINDER_COLUMN_MAPPINGORGANISATIONID_GROUPID_2 = "workingUnit.groupId = ? AND ";
	private static final String _FINDER_COLUMN_MAPPINGORGANISATIONID_MAPPINGORGANISATIONID_2 =
		"workingUnit.mappingOrganisationId = ?";
	...
	public void cacheResult(WorkingUnit workingUnit) {
		...
		FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
			new Object[] {
				workingUnit.getGroupId(), workingUnit.getMappingOrganisationId()
			}, workingUnit);
	...
	protected void cacheUniqueFindersCache(WorkingUnit workingUnit) {
		if (workingUnit.isNew()) {
			...
			args = new Object[] {
					workingUnit.getGroupId(),
					workingUnit.getMappingOrganisationId()
				};

			FinderCacheUtil.putResult(FINDER_PATH_COUNT_BY_MAPPINGORGANISATIONID,
				args, Long.valueOf(1));
			FinderCacheUtil.putResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
				args, workingUnit);
		}
			...
			if ((workingUnitModelImpl.getColumnBitmask() &
					FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						workingUnit.getGroupId(),
						workingUnit.getMappingOrganisationId()
					};
	...
	protected void clearUniqueFindersCache(WorkingUnit workingUnit) {
		...
		FinderCacheUtil.removeResult(FINDER_PATH_COUNT_BY_MAPPINGORGANISATIONID,
			args);
		FinderCacheUtil.removeResult(FINDER_PATH_FETCH_BY_MAPPINGORGANISATIONID,
			args);
		...
		if ((workingUnitModelImpl.getColumnBitmask() &
			...
			args = new Object[] {
					workingUnitModelImpl.getOriginalGroupId(),
					workingUnitModelImpl.getOriginalMappingOrganisationId()
				};

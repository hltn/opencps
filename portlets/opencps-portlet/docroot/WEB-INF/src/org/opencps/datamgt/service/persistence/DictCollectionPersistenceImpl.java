...
public class DictCollectionPersistenceImpl extends BasePersistenceImpl<DictCollection>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_C = new FinderPath(DictCollectionModelImpl.ENTITY_CACHE_ENABLED,
			DictCollectionModelImpl.FINDER_CACHE_ENABLED,
			DictCollectionImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByG_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_C = new FinderPath(DictCollectionModelImpl.ENTITY_CACHE_ENABLED,
			DictCollectionModelImpl.FINDER_CACHE_ENABLED,
			DictCollectionImpl.class,
	 ...
	 */
	@Override
	public List<DictCollection> findByG_C(long groupId, String collectionCode)
		throws SystemException {
		return findByG_C(groupId, collectionCode, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DictCollection> findByG_C(long groupId, String collectionCode,
		...
		return findByG_C(groupId, collectionCode, start, end, null);
	}
	...
	public List<DictCollection> findByG_C(long groupId, String collectionCode,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { groupId, collectionCode };
		}
		else {
	 ...
	 */
	@Override
	public DictCollection findByG_C_First(long groupId, String collectionCode,
		OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		DictCollection dictCollection = fetchByG_C_First(groupId,
	 ...
	 */
	@Override
	public DictCollection fetchByG_C_First(long groupId, String collectionCode,
		OrderByComparator orderByComparator) throws SystemException {
		List<DictCollection> list = findByG_C(groupId, collectionCode, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DictCollection findByG_C_Last(long groupId, String collectionCode,
		OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		DictCollection dictCollection = fetchByG_C_Last(groupId,
				collectionCode, orderByComparator);
	 ...
	 */
	@Override
	public DictCollection fetchByG_C_Last(long groupId, String collectionCode,
		OrderByComparator orderByComparator) throws SystemException {
		int count = countByG_C(groupId, collectionCode);

		if (count == 0) {
			return null;
		}

		List<DictCollection> list = findByG_C(groupId, collectionCode,
	 ...
	 */
	@Override
	public DictCollection[] findByG_C_PrevAndNext(long dictCollectionId,
		long groupId, String collectionCode, OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		DictCollection dictCollection = findByPrimaryKey(dictCollectionId);
		...
		try {
			...
			array[0] = getByG_C_PrevAndNext(session, dictCollection, groupId,
					collectionCode, orderByComparator, true);

			array[1] = dictCollection;

			array[2] = getByG_C_PrevAndNext(session, dictCollection, groupId,
					collectionCode, orderByComparator, false);
	...
	protected DictCollection getByG_C_PrevAndNext(Session session,
		DictCollection dictCollection, long groupId, String collectionCode,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public List<DictCollection> filterFindByG_C(long groupId,
		String collectionCode) throws SystemException {
		return filterFindByG_C(groupId, collectionCode, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	@Override
	public List<DictCollection> filterFindByG_C(long groupId,
		String collectionCode, int start, int end) throws SystemException {
		return filterFindByG_C(groupId, collectionCode, start, end, null);
	}
	...
	@Override
	public List<DictCollection> filterFindByG_C(long groupId,
		String collectionCode, int start, int end,
		OrderByComparator orderByComparator) throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C(groupId, collectionCode, start, end,
				orderByComparator);
		}
	 ...
	 */
	@Override
	public DictCollection[] filterFindByG_C_PrevAndNext(long dictCollectionId,
		long groupId, String collectionCode, OrderByComparator orderByComparator)
		throws NoSuchDictCollectionException, SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C_PrevAndNext(dictCollectionId, groupId,
				collectionCode, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_C_PrevAndNext(session, dictCollection,
					groupId, collectionCode, orderByComparator, true);

			array[1] = dictCollection;

			array[2] = filterGetByG_C_PrevAndNext(session, dictCollection,
					groupId, collectionCode, orderByComparator, false);
	...
	protected DictCollection filterGetByG_C_PrevAndNext(Session session,
		DictCollection dictCollection, long groupId, String collectionCode,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByG_C(long groupId, String collectionCode)
		throws SystemException {
		for (DictCollection dictCollection : findByG_C(groupId, collectionCode,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dictCollection);
		}
	}
	 ...
	 */
	@Override
	public int filterCountByG_C(long groupId, String collectionCode)
		throws SystemException {
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return countByG_C(groupId, collectionCode);
		}

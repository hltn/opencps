...
public class BusinessDomainPersistenceImpl extends BasePersistenceImpl<BusinessDomain>
	 ...
	 */
	@Override
	public BusinessDomain[] findByBusinessId_PrevAndNext(long domainId,
		long businessId, OrderByComparator orderByComparator)
		throws NoSuchBusinessDomainException, SystemException {
		BusinessDomain businessDomain = findByPrimaryKey(domainId);
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_BUSINESSDOMAIN =
		new FinderPath(BusinessDomainModelImpl.ENTITY_CACHE_ENABLED,
			...
			BusinessDomainModelImpl.BUSINESSDOMAINCODE_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<BusinessDomain> findByBusinessDomain(String businessDomainCode)
		throws SystemException {
		return findByBusinessDomain(businessDomainCode, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<BusinessDomain> findByBusinessDomain(
		String businessDomainCode, int start, int end)
		throws SystemException {
		return findByBusinessDomain(businessDomainCode, start, end, null);
	}
	...
	public List<BusinessDomain> findByBusinessDomain(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { businessDomainCode };
		}
		else {
		...
		if ((list != null) && !list.isEmpty()) {
			for (BusinessDomain businessDomain : list) {
				if (!Validator.equals(businessDomainCode,
							businessDomain.getBusinessDomainCode())) {
					list = null;
		...
		if (list == null) {
			...
			boolean bindBusinessDomainCode = false;

			if (businessDomainCode == null) {
				query.append(_FINDER_COLUMN_BUSINESSDOMAIN_BUSINESSDOMAINCODE_1);
			}
			else if (businessDomainCode.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_BUSINESSDOMAIN_BUSINESSDOMAINCODE_3);
			}
			else {
				bindBusinessDomainCode = true;

				query.append(_FINDER_COLUMN_BUSINESSDOMAIN_BUSINESSDOMAINCODE_2);
			}
			...
			try {
				...
				if (bindBusinessDomainCode) {
					qPos.add(businessDomainCode);
				}
	 ...
	 */
	@Override
	public BusinessDomain findByBusinessDomain_First(
		String businessDomainCode, OrderByComparator orderByComparator)
		throws NoSuchBusinessDomainException, SystemException {
		BusinessDomain businessDomain = fetchByBusinessDomain_First(businessDomainCode,
				orderByComparator);
	 ...
	 */
	@Override
	public BusinessDomain fetchByBusinessDomain_First(
		String businessDomainCode, OrderByComparator orderByComparator)
		throws SystemException {
		List<BusinessDomain> list = findByBusinessDomain(businessDomainCode, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public BusinessDomain findByBusinessDomain_Last(String businessDomainCode,
		OrderByComparator orderByComparator)
		throws NoSuchBusinessDomainException, SystemException {
		BusinessDomain businessDomain = fetchByBusinessDomain_Last(businessDomainCode,
				orderByComparator);
	 ...
	 */
	@Override
	public BusinessDomain fetchByBusinessDomain_Last(
		String businessDomainCode, OrderByComparator orderByComparator)
		throws SystemException {
		int count = countByBusinessDomain(businessDomainCode);

		if (count == 0) {
			return null;
		}

		List<BusinessDomain> list = findByBusinessDomain(businessDomainCode,
	 ...
	 */
	@Override
	public BusinessDomain[] findByBusinessDomain_PrevAndNext(long domainId,
		String businessDomainCode, OrderByComparator orderByComparator)
		throws NoSuchBusinessDomainException, SystemException {
		BusinessDomain businessDomain = findByPrimaryKey(domainId);
		...
		try {
			...
			array[0] = getByBusinessDomain_PrevAndNext(session, businessDomain,
					businessDomainCode, orderByComparator, true);

			array[1] = businessDomain;

			array[2] = getByBusinessDomain_PrevAndNext(session, businessDomain,
					businessDomainCode, orderByComparator, false);
	...
	protected BusinessDomain getByBusinessDomain_PrevAndNext(Session session,
		BusinessDomain businessDomain, String businessDomainCode,
		OrderByComparator orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByBusinessDomain(String businessDomainCode)
		throws SystemException {
		for (BusinessDomain businessDomain : findByBusinessDomain(
				businessDomainCode, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(businessDomain);
		}
	}
	 ...
	 */
	@Override
	public int countByBusinessDomain(String businessDomainCode)
		throws SystemException {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_BUSINESSDOMAIN;

		Object[] finderArgs = new Object[] { businessDomainCode };
	...
	private static final String _FINDER_COLUMN_BUSINESSDOMAIN_BUSINESSDOMAINCODE_1 =
		"businessDomain.businessDomainCode IS NULL";
	private static final String _FINDER_COLUMN_BUSINESSDOMAIN_BUSINESSDOMAINCODE_2 =
		"businessDomain.businessDomainCode = ?";
	private static final String _FINDER_COLUMN_BUSINESSDOMAIN_BUSINESSDOMAINCODE_3 =
		"(businessDomain.businessDomainCode IS NULL OR businessDomain.businessDomainCode = '')";
	 ...
	 */
	@Override
	public BusinessDomain create(long domainId) {
		BusinessDomain businessDomain = new BusinessDomainImpl();

		businessDomain.setNew(true);
		businessDomain.setPrimaryKey(domainId);
	 ...
	 */
	@Override
	public BusinessDomain remove(long domainId)
		throws NoSuchBusinessDomainException, SystemException {
		return remove((Serializable)domainId);
	}
	...
	public BusinessDomain updateImpl(
		...
		if (isNew || !BusinessDomainModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((businessDomainModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						businessDomainModelImpl.getOriginalBusinessDomainCode()
					};
				...
				args = new Object[] {
						businessDomainModelImpl.getBusinessDomainCode()
					};
	...
	protected BusinessDomain toUnwrappedModel(BusinessDomain businessDomain) {
		...
		businessDomainImpl.setDomainId(businessDomain.getDomainId());
		businessDomainImpl.setBusinessId(businessDomain.getBusinessId());
		businessDomainImpl.setBusinessDomainCode(businessDomain.getBusinessDomainCode());
	 ...
	 */
	@Override
	public BusinessDomain findByPrimaryKey(long domainId)
		throws NoSuchBusinessDomainException, SystemException {
		return findByPrimaryKey((Serializable)domainId);
	}
	 ...
	 */
	@Override
	public BusinessDomain fetchByPrimaryKey(long domainId)
		throws SystemException {
		return fetchByPrimaryKey((Serializable)domainId);
	}

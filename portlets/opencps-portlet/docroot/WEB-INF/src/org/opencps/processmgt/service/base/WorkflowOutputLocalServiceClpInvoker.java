...
public class WorkflowOutputLocalServiceClpInvoker {
	public WorkflowOutputLocalServiceClpInvoker() {
		...
		_methodName102 = "updateWorkflowOutput";

		_methodParameterTypes102 = new String[] {
				"long", "long", "long", "boolean", "boolean", "boolean"
			};

		_methodName103 = "addWorkflowOutput";

		_methodParameterTypes103 = new String[] {
				"long", "long", "boolean", "boolean", "boolean"
			};

		_methodName104 = "getByProcessWF";

		_methodParameterTypes104 = new String[] { "long" };

		_methodName105 = "getByProcessWFPostback";

		_methodParameterTypes105 = new String[] { "long", "boolean" };

		_methodName106 = "getProcessByE_S_ID_PB";

		_methodParameterTypes106 = new String[] { "long", "boolean" };
	}
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName105.equals(name) &&
			...
			return WorkflowOutputLocalServiceUtil.getByProcessWFPostback(((Long)arguments[0]).longValue(),
				((Boolean)arguments[1]).booleanValue());
		}

		if (_methodName106.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes106, parameterTypes)) {
			return WorkflowOutputLocalServiceUtil.getProcessByE_S_ID_PB(((Long)arguments[0]).longValue(),
				((Boolean)arguments[1]).booleanValue());
		}

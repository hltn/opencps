...
public class ServiceInfoProcessLocalServiceClpInvoker {
	public ServiceInfoProcessLocalServiceClpInvoker() {
		...
		_methodName102 = "addProcessServiceInfos";

		_methodParameterTypes102 = new String[] { "long", "long[][]" };

		_methodName103 = "deleteServiceInfoProcess";

		_methodParameterTypes103 = new String[] { "long", "long" };

		_methodName104 = "addServiceInfoProcess";

		_methodParameterTypes104 = new String[] { "long", "long" };

		_methodName105 = "getServiceInfoProcessByProcessId";

		_methodParameterTypes105 = new String[] { "long" };

		_methodName106 = "getServiceInfo";

...
public class ActionHistoryLocalServiceClpInvoker {
	public ActionHistoryLocalServiceClpInvoker() {
		...
		_methodName102 = "addActionHistory";
		...
		_methodName103 = "addActionHistory";
		...
		_methodName104 = "getLatestActionHistory";

		_methodParameterTypes104 = new String[] { "long", "long" };

		_methodName105 = "getActionHistory";

		_methodParameterTypes105 = new String[] { "long", "long" };

		_methodName106 = "searchActionHistoryByDossierId";

		_methodParameterTypes106 = new String[] { "long", "long" };

		_methodName107 = "getActionHistoriesByG_PORD";

		_methodParameterTypes107 = new String[] { "long", "long", "int", "int" };

		_methodName108 = "counAcionHistoriesByG_PORD";

		_methodParameterTypes108 = new String[] { "long", "long" };

		_methodName109 = "getActionHistoryByProcessOrderId";

		_methodParameterTypes109 = new String[] { "long", "int", "int" };

		_methodName110 = "countActionHistoryByProcessId";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName106.equals(name) &&
			...
			return ActionHistoryLocalServiceUtil.searchActionHistoryByDossierId(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName107.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes107, parameterTypes)) {
			return ActionHistoryLocalServiceUtil.getActionHistoriesByG_PORD(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue(),
				((Integer)arguments[2]).intValue(),
		...
		if (_methodName108.equals(name) &&
			...
			return ActionHistoryLocalServiceUtil.counAcionHistoriesByG_PORD(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}

		if (_methodName109.equals(name) &&
				Arrays.deepEquals(_methodParameterTypes109, parameterTypes)) {
			return ActionHistoryLocalServiceUtil.getActionHistoryByProcessOrderId(((Long)arguments[0]).longValue(),
				((Integer)arguments[1]).intValue(),
				((Integer)arguments[2]).intValue());
		}
		...
		if (_methodName110.equals(name) &&
			...
			return ActionHistoryLocalServiceUtil.countActionHistoryByProcessId(((Long)arguments[0]).longValue());
		}
